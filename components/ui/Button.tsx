...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-synapse-600 hover:bg-synapse-700 text-white shadow-lg shadow-synapse-500/30 focus:ring-synapse-500",
    ...
    outline: "border-2 border-synapse-600 text-synapse-600 hover:bg-synapse-50"
  };
